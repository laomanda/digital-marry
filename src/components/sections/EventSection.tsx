...
function EventCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-br via-transparent to-transparent opacity-70 from-[#F5F5F0]/[0.055]"
        aria-hidden="true"
      />
      <div
        ...
        aria-hidden="true"
      />
      <div className="pointer-events-none absolute left-0 top-0 h-px w-10 transition-all duration-500 group-hover/card:w-20 bg-[#F5F5F0]/20 group-hover/card:bg-[#F5F5F0]/45" aria-hidden="true" />
      <div className="pointer-events-none absolute bottom-0 right-0 h-px w-10 transition-all duration-500 group-hover/card:w-20 bg-[#F5F5F0]/15 group-hover/card:bg-[#F5F5F0]/35" aria-hidden="true" />
      ...
      <div className="relative z-10 flex h-full flex-col">
        <div className="mb-7 flex items-start justify-between gap-5 [@media(max-height:650px)]:mb-5">
          <div>
            <span className="mb-4 block font-mono text-[10px] uppercase transition-colors duration-500 text-[#A4A4A4]">
              Rangkaian {number}
            </span>
  ...
  return (
    <div ref={stageRef} className="relative hidden h-[clamp(620px,82vh,760px)] min-h-[620px] overflow-x-hidden overflow-y-visible lg:block [@media(max-height:650px)]:h-[420px] [@media(max-height:650px)]:min-h-[420px]">
      ...
      >
        ...
        >
          <span className="mb-4 h-10 w-px transition-colors duration-500 bg-[#F5F5F0]/20" aria-hidden="true" />
          <span className="border px-6 py-4 font-mono text-[10px] uppercase transition-colors duration-500 bg-[#050505] border-[#F5F5F0]/14 text-[#F5F5F0]">
            Akad menuju Resepsi
          </span>
          <span className="mt-4 h-10 w-px transition-colors duration-500 bg-[#F5F5F0]/20" aria-hidden="true" />
        </div>
...
export default function EventSection() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden py-24 md:py-32 lg:py-24 [@media(max-height:650px)]:py-8 transition-colors duration-500 bg-[#050505] text-[#F5F5F0]"
    >
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute left-1/2 top-0 h-full max-w-none object-cover object-center will-change-transform max-lg:w-[115vw] max-lg:-translate-x-1/2 max-lg:opacity-[0.34] lg:opacity-[0.52] lg:w-[140vw]"
          style={{ filter: 'grayscale(1) contrast(1.04) brightness(0.82)' }}
        />
        <div className="absolute inset-0 transition-colors duration-500 bg-[#050505]/72 md:bg-[#050505]/62" />
        <div
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-[3] h-36 transition-colors duration-500 md:h-48 bg-gradient-to-b from-[#050505] via-[#050505]/70 to-transparent" aria-hidden="true" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 z-[3] h-36 transition-colors duration-500 md:h-48 bg-gradient-to-t from-[#050505] via-[#050505]/70 to-transparent" aria-hidden="true" />
